...
exports.editForm = (req, res) => {
  res.send("Edit family feature coming soon!");
};

exports.updateFamily = (req, res) => {
  res.send("Update family feature coming soon!");
};

exports.deleteFamily = (req, res) => {
  res.send("Delete family feature coming soon!");
};

exports.showAddChild = (req, res) => {
  res.send("Add child feature coming soon!");
};
